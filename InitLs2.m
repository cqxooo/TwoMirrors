function ls = InitLs2(polyBoundaryVecCell, cp, theta, lh, v, T)
...
vz2=a+0.618*(b-a);
[cost2 ~] = getLs2(polyBoundaryVecCell, cp, theta, lh, vz2, T);
vz1=a+0.382*(b-a);
[cost1 ~] = getLs2(polyBoundaryVecCell, cp, theta, lh, vz1, T);
...
vz=(a+b)/2;
[cost ls] = getLs2(polyBoundaryVecCell, cp, theta, lh, vz, T);
