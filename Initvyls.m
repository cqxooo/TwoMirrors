function ls = Initvyls(polyBoundaryVecCell, cp, theta, lh, v, T)
...
% mid = a+b/2;
epsilon=1e-9;
[cost ls] = Golden(q2, q1, polyBoundaryVecCell, data, T, epsilon);
...
function [cost ls] = Golden(a, b, polyBoundaryVecCell, data, T, epsilon)
vz2=a+0.618*(b-a);
[cost2 ~] = getvy(a, b, polyBoundaryVecCell, data, vz2, T);
vz1=a+0.382*(b-a);
[cost1 ~] = getvy(a, b, polyBoundaryVecCell, data, vz1, T);
...
vz=(a+b)/2;
[cost ls] = getvy(a,b, polyBoundaryVecCell, data, vz, T);
