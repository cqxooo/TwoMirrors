function ls = getvzls(polyBoundaryVecCell, cp, theta, lh, v, T)
...
% mid = a+b/2;
epsilon=1e-9;
vz  = Golden(a, b, cp, lh, v, epsilon);
ls = getLs1D(polyBoundaryVecCell, cp, theta, lh, vz, T);
...
function vz = Golden(a, b, cp, lh, v, epsilon)
vz2=a+0.618*(b-a);
cost2 = getvz1D(cp, lh, vz2, v);
vz1=a+0.382*(b-a);
cost1 = getvz1D(cp, lh, vz1, v);
